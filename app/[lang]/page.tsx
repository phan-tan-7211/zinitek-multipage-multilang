        ...
        <section className="py-24 bg-transparent relative">
          <div className="container mx-auto px-4 lg:px-6">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {/* Bài viết số 1 */}
              <article className="group bg-card/80 backdrop-blur-sm rounded-2xl overflow-hidden border border-border/50 hover:border-[#f97316]/30 transition-all">
                ...
                <div className="p-6">
                  ...
                  <Link href={`/${lang}/blog`} className="text-sm font-semibold text-foreground flex items-center gap-2 hover:text-[#f97316] transition-colors">
