...
> **Status note:** Đây là roadmap kỹ thuật tích lũy trong quá trình phát triển. Một số hạng mục có thể đã hoàn thành hoặc thay đổi kiến trúc kể từ lần cập nhật cuối. Trước khi thực hiện một mục chưa hoàn thành, phải đối chiếu với source code hiện tại và các rule trong `AGENTS.md`.
