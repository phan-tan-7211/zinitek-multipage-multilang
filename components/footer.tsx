        ...
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-4 lg:gap-8">
          <div>
            ...
            <p className="mb-6 max-w-sm text-sm leading-6 text-muted-foreground">
              {footer?.description || "Đối tác tin cậy trong lĩnh vực gia công cơ khí chính xác theo tiêu chuẩn Nhật Bản."}
            </p>
            ...
            <div className="flex gap-2">
              {socialLinks.map(({ icon: Icon, href, label }) => (
                <a
                  ...
                  href={href}
                  aria-label={label}
                  className="inline-flex size-11 items-center justify-center rounded-xl border border-border/60 bg-card text-muted-foreground shadow-soft transition-all hover:-translate-y-0.5 hover:border-primary/20 hover:bg-primary/5 hover:text-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
                >
          ...
          <div>
            ...
            <div className="mb-7 space-y-3">
              ...
              <a href={`tel:${common?.phone_label}`} className="flex min-h-10 items-center gap-3 rounded-md text-sm text-muted-foreground transition-colors hover:text-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring">
                <Phone className="size-5 shrink-0 text-primary" aria-hidden="true" />
                {common?.phone_label || "+84 77 622 0031"}
              </a>
              <a href={`mailto:${common?.email_label}`} className="flex min-h-10 items-center gap-3 rounded-md text-sm text-muted-foreground transition-colors hover:text-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring">
                <Mail className="size-5 shrink-0 text-primary" aria-hidden="true" />
                <span className="break-all">{common?.email_label || "phantan7211@gmail.com"}</span>
              </a>
            </div>
            ...
            <form className="flex gap-2" onSubmit={(event) => event.preventDefault()}>
              <Input
                type="email"
                aria-label={footer?.placeholder_email || "Email của bạn"}
                placeholder={footer?.placeholder_email || "Email của bạn"}
                className="h-11 flex-1 rounded-xl border-border bg-background text-sm focus-visible:ring-ring"
              />
