...
export function AboutSummary({ lang, dict }: { lang: string; dict: any }) {
  ...
  // 1. Gán biến dữ liệu từ dict (có fallback để không bao giờ bị trống)
  ...
  // 2. Chuyển features sang đa ngôn ngữ hoàn toàn
  const features = [
    { 
      icon: Target, 
            ...
            <div className="relative w-full max-w-[480px] aspect-square flex items-center justify-center">
              ...
              <div className="absolute inset-24 bg-gradient-to-br from-[#0f172a] to-[#020617] rounded-full border border-slate-700 flex flex-col items-center justify-center shadow-[0_0_50px_rgba(249,115,22,0.1)] z-10 text-center px-6">
                ...
                <div className="mt-4 text-[10px] text-slate-500 font-mono">
                  {lang === 'vi' ? "Bến Cát, Bình Dương" : "Ben Cat, Binh Duong"}
                </div>
              </div>

              {/* Floating Tags - Cố định chữ kỹ thuật quốc tế */}
              <motion.div 
